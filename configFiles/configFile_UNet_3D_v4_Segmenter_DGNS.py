...
trainChannels = ['/CV_folds/CV_nov/SEGMENTER_F4_QC/train_t1post.txt',
		 '/CV_folds/CV_nov/SEGMENTER_F4_QC/train_sub1.txt',
		 '/CV_folds/CV_nov/SEGMENTER_F4_QC/train_sub2.txt']

trainLabels   = '/CV_folds/CV_nov/SEGMENTER_F4_QC/train_labels.txt'
    
testChannels  = ['/CV_folds/CV_nov/SEGMENTER_F4_QC/val_t1post.txt',
		 '/CV_folds/CV_nov/SEGMENTER_F4_QC/val_sub1.txt',
		 '/CV_folds/CV_nov/SEGMENTER_F4_QC/val_sub2.txt']

testLabels = '/CV_folds/CV_nov/SEGMENTER_F4_QC/val_labels.txt'
...
list_subjects_fullSegmentation = np.arange(0,60,1) # Leave empty if random
