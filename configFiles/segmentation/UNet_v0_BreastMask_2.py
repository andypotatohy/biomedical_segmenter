...
segmentChannels = ['/CV_folds/CV_Replicate_Aug2019/train_t1post.txt']#['/CV_folds/CV_nov/SEGMENTER/test_t1post.txt']
...
OUTPUT_PATH = '/home/deeperthought/kirby_MSK/BreastMasks/predictions/'  # default is training session
save_as_nifti = True  
dice_compare = False
full_segmentation_patches = True
test_subjects = 80000
n_fullSegmentations = 80000
list_subjects_fullSegmentation = range(18000,36000)#range(0,20000)
