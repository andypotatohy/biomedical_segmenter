...
segmentChannels = ['/CV_folds/CV_nov/DGNS/benigns_t1post.txt',
		 '/CV_folds/CV_nov/DGNS/benigns_segmented_test_sub1.txt',
		 '/CV_folds/CV_nov/DGNS/benigns_segmented_test_sub2.txt']
segmentLabels = ''
...
dice_compare = False
save_as_nifti = True  
OUTPUT_PATH = '/home/deeperthought/kirby_MSK/DGNS_INPUT_Jan2020/UNet_3D_v4_MSKCC_configFile_UNet_3D_v4_Segmenter_DGNS_2020-01-15_1823/benigns/'
percentile_normalization = True
full_segmentation_patches = True
test_subjects = 30199
n_full_segmentations = 30199
list_subjects_fullSegmentation = range(15000,30000)
