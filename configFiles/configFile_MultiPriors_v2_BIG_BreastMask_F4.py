...
trainChannels = ['/CV_folds/CV_alignedNii-Aug2019-BreastMask/train_t1post.txt',
		 '/CV_folds/CV_alignedNii-Aug2019-BreastMask/train_sub.txt']

trainLabels   = '/CV_folds/CV_alignedNii-Aug2019-BreastMask/train_labels.txt'
    
testChannels  = ['/CV_folds/CV_alignedNii-Aug2019-BreastMask/val_t1post.txt',
		 '/CV_folds/CV_alignedNii-Aug2019-BreastMask/val_sub.txt']

testLabels = '/CV_folds/CV_alignedNii-Aug2019-BreastMask/val_labels.txt'
...
load_model = True
path_to_model = '/home/deeperthought/Projects/MultiPriors_MSKCC/training_sessions/MultiPriors_v2_Big_MSKCC_configFile_MultiPriors_v2_BIG_BreastMask_F4_2019-12-06_1424/models/v2_Big_MSKCC_configFile_MultiPriors_v2_BIG_BreastMask_F4_2019-12-06_1424.log_epoch15.h5'
if load_model:
...
samplingMethod_train = 2
samplingMethod_val = 2
