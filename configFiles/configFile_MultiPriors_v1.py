...
load_model = True
path_to_model = '/home/deeperthought/Projects/MultiPriors_MSKCC/training_sessions/MultiPriors_v1_MSKCC_configFile_MultiPriors_v1_2019-10-31_1830/models/v1_MSKCC_configFile_MultiPriors_v1_2019-10-31_1830.log_epoch41.h5'
if load_model:
...
n_full_segmentations = 30
full_segmentation_patches = True
size_test_minibatches = 500
list_subjects_fullSegmentation = np.arange(0,30,1) # Leave empty if random
epochs_for_fullSegmentation = np.arange(1,epochs+1,5) # [1,5,10,15,20,25,29]
saveSegmentation = True
proportion_malignants_fullSegmentation = 0.67
