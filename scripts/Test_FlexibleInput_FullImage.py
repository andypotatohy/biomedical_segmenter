# -*- coding: utf-8 -*-
"""
Created on Thu Dec 13 16:39:08 2018
...
configFile = '/home/hirsch/Documents/projects/Breast_segmentation/DeepPriors_package/configFiles/configFile_DM.py'
workingDir ='/home/hirsch/projects/mskProj/DeepPriors_package/'
...
x = np.random.rand(1,13,75,75,1)
tpm = np.random.rand(1,1,9,9,1)
x.shape
yhat = model.predict([x,x,x,tpm])
yhat.shape

model.evaluate([x,x,x,tpm], yhat)
