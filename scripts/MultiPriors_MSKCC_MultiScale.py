...
class MultiPriors_v0():
    ...
    def createModel(self):
        ...
        x12 = AveragePooling3D(pool_size=(1, 3, 3), name='T1post_Context')(T1post)    
        # (13, 25, 25)        
        for iii in range(6):    
...
class MultiPriors_v1():
    ...
    def createModel(self):
        ...
        ########################  T1 pre pathway #########################
        #############   High res pathway   ##################         
        x2        = Cropping3D(cropping = ((0,0),(20,20),(20,20)), input_shape=(None,None,None, self.num_channels),name = 'T1pre_Detail')(T1pre)
...
#yhat = model.predict([X, X, coords])
#print(yhat.shape)
#model.fit([X, X, coords], y, epochs=10)
